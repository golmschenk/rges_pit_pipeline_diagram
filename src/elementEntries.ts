            ...
            dataElements: [
                ...
                },
                {
                    ...
                    notes: 'Deep, comprehensive analysis producing maps over q,s space\n' +
                        'First season: Deliver a global q,s map over all events\n' +
                        'Three seasons: Deliver comprehensive q,s,alpha maps for each event, targeting grids of 100 q (from 1e-6 to 1e-1) x 100 s (from 0.1 to 6 θE) x 360 alpha (from 1 to 360 degrees)\n' +
                        'In addition, the PIT will develop and deliver additional statistics for detection efficiency maps.',
                },
                {
